...
final class Version20201022084118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE report ADD comment_id_id INT NOT NULL, ADD user_id_id INT NOT NULL, ADD reason_id_id INT NOT NULL, DROP comment_id, DROP user_id, DROP reason_id');
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F77849D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784D6DE06A6 FOREIGN KEY (comment_id_id) REFERENCES comment (id)');
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784F3D025E7 FOREIGN KEY (reason_id_id) REFERENCES report_reason (id)');
        $this->addSql('CREATE INDEX IDX_C42F7784D6DE06A6 ON report (comment_id_id)');
        $this->addSql('CREATE INDEX IDX_C42F77849D86650F ON report (user_id_id)');
        $this->addSql('CREATE INDEX IDX_C42F7784F3D025E7 ON report (reason_id_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C42F77849D86650F ON report');
        $this->addSql('DROP INDEX IDX_C42F7784F3D025E7 ON report');
        $this->addSql('ALTER TABLE report ADD comment_id INT NOT NULL, ADD user_id INT NOT NULL, ADD reason_id INT NOT NULL, DROP comment_id_id, DROP user_id_id, DROP reason_id_id');
